...
for i in range(int(case_number)):
    ((x1,y1),(x2,y2)),((x3,y3),(x4,y4)),((x5,y5),(x6,y6)) = test_case_check((randint(1,50), randint(1,50)),(randint(1,50),randint(1,50))),test_case_check((randint(1,50), randint(1,50)),(randint(1,50),randint(1,50))),test_case_check((randint(1,50), randint(1,50)),(randint(1,50),randint(1,50)))

    cases.append(tuple(((x1,y1),(x2,y2),(x3,y3),(x4,y4),(x5,y5),(x6,y6))))
    r1 = isCovered((x1,y1),(x2,y2),(x3,y3),(x4,y4),(x5,y5),(x6,y6))
    r2 = os.popen("echo {} {} {} {} {} {} {} {} {} {} {} {} | ./test".format(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5,x6,y6)).read()
    if r1 == r2[:-1]:
        print "Successful"
        successful_cases.append(tuple(((x1,y1),(x2,y2),(x3,y3),(x4,y4),(x5,y5),(x6,y6))))
        f.write("Successful in case {}: ".format(i) + str(cases[i])+"\n")
    else:
        print "Failed in case {}: ".format(i)
        failed_cases.append(tuple(((x1,y1),(x2,y2),(x3,y3),(x4,y4),(x5,y5),(x6,y6))))
